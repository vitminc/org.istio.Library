...
class BackendStorageProvider implements UserStorageProvider,
    ...
    public BackendStorageProvider(KeycloakSession session, ComponentModel model, UserRepository repository) {
